...
import articles from '@/data/en_blog_articles.json';

export const metadata = {
  title: 'Ecommerce Automation & Integration Blog | WordPress.velar+',
  description: 'In-depth guides, architectural blueprints, and playbooks for scaling multi-channel ecommerce on Shopify, WooCommerce, Magento 2, and BigCommerce.',
};
      ...
      <main className="flex-grow bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          ...
          <div className="max-w-3xl mb-12">
            <span className="text-blue-600 font-semibold text-sm tracking-wide uppercase">Knowledge Base & Playbooks</span>
            <h1 className="text-3xl sm:text-5xl font-extrabold text-slate-900 mt-2 mb-4">
              Ecommerce Engineering & Integration Blog
            </h1>
            <p className="text-lg text-slate-600 leading-relaxed">
              No fluff, production-tested guides. Discover how to sync multi-channel inventory, route orders to Amazon FBA, automate accounting, and optimize checkout conversion rates without recurring SaaS subscriptions.
            </p>
          </div>
                ...
                <div className="lg:col-span-8">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-xs text-slate-400 font-medium">
                      ⏱ {featuredArticle.read_time} read
                    </span>
                  </div>
                  <Link href={`/en/blog/${featuredArticle.slug}`}>
                  ...
                  <div className="flex items-center gap-4">
                    <Link
                      href={`/en/blog/${featuredArticle.slug}`}
                    ...
                    <span className="text-xs text-slate-400">
                      Updated: {featuredArticle.published_date}
                    </span>
                  </div>
                </div>
                <div className="lg:col-span-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100/60">
                  <div className="text-xs font-bold text-blue-600 uppercase tracking-wider mb-2">Key Strategic Benefit</div>
                  <div className="text-slate-800 font-semibold text-base mb-3 leading-snug">
                    {featuredArticle.hero.key_benefit}
                  </div>
                  <div className="text-xs text-slate-500">
                    Target Keyword: <span className="font-mono text-slate-700">{featuredArticle.primary_keyword}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Grid of articles */}
          <div className="mb-10">
            <h2 className="text-2xl font-bold text-slate-900 mb-6">All Guides & Architecture Blueprints ({articles.length})</h2>
          ...
          <div className="bg-gradient-to-r from-slate-900 to-indigo-950 rounded-3xl p-8 sm:p-12 text-white text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-8 mt-16">
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold mb-2">Looking for a ready-made extension?</h2>
              <p className="text-slate-300 max-w-xl text-sm sm:text-base">
                Browse our catalog of 20+ global integrations for Shopify, WooCommerce, Magento 2, and BigCommerce with zero monthly fees.
              </p>
            </div>
            <Link
              href="/en/catalog"
